...
<link href="company_css.css" rel="stylesheet" type="text/css" media="screen" />
</head>
<body>
<div id="wrapper">
	...
	<div id="menu">
		<ul>
            ...
            <li><a href="company_certificate.php">jobseeker</a></li>
			...
			<div id="page-bgbtm">
				<div id="content">
					<div class="post">
						...
						<p><?php $data=mysqli_query($con,"SELECT * from company where account= '$account'"); 
